...
export const StorageRepository = {
  ...
  /**
   * Get audio file ID for a note (convenience method)
   */
  async getAudioId(noteId: string): Promise<string | null> {
    const files = await this.getFilesForNote(noteId);
    const audio = files.find((f) => f.mime_type.startsWith("audio/"));
